...
function create_test(){
  ...
  this
    .canSeeAndClick("the sorter button", "#nbpresent-app-btn")
    .canSeeAndClick("the add slide button",
      ".nbpresent-deck-toolbar .fa-plus-square-o")
    ...
    .canSeeAndClick("the return to notebook button",
      ".fa-book")
    .canSeeAndClick("the edit button", ".nbpresent-deck-toolbar .fa-edit")
    .canSeeAndClick("a region in the region tree",
      ".nbpresent-regiontree .region")
    .canSeeAndClick("the treemap layout button",
      ".nbpresent-regiontree .fa-tree")
    ...
    .canSeeAndClick("the manual layout button",
      ".nbpresent-regiontree .fa-arrows")
    ...
    .waitWhileVisible(".nbpresent-regiontree")
    .canSeeAndClick("the presenter button", "#nbpresent_present_btn")
    .canSeeAndClick("the presenter", ".nbpresent_presenter")
}
