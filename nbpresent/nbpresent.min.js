...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}(),_jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_d3=require("d3"),_d32=_interopRequireDefault(_d3),_baobab=require("baobab"),_baobab2=_interopRequireDefault(_baobab),_baseJsNamespace=require("base/js/namespace"),_baseJsNamespace2=_interopRequireDefault(_baseJsNamespace),_presenter=require("./presenter"),_sorter=require("./sorter"),_notebookJsCelltoolbar=require("notebook/js/celltoolbar"),_parts=require("./parts"),_tour=require("./tour"),NBPresent=function(){function e(){var t=this;_classCallCheck(this,e),this.tree=new _baobab2["default"]({slides:this.metadata().slides,presenter:{},sorter:{},editor:{},sortedSlides:_baobab2["default"].monkey(["slides"],this.sortedSlides)}),this.slides=this.tree.select(["slides"]),this.slides.on("update",function(){return t.metadata(!0)}),this.tour=new _tour.Tour(this),this.tour.init(),this.presenter=new _presenter.Presenter(this.tree,this.tour),this.sorter=new _sorter.Sorter(this.tree,this.tour),this.initToolbar()}return _createClass(e,[{key:"metadata",value:function(e){var t=_baseJsNamespace2["default"].notebook.metadata;return e?void(t.nbpresent={slides:this.slides.serialize()}):t.nbpresent||{slides:{}}}},{key:"sortedSlides",value:function(e){var t=_d32["default"].entries(e);return t.sort(function(e,t){return null===e.value.prev||e.key===t.value.prev?-1:1}),t}},{key:"show",value:function(){this.sorter.show(),this.tour.start(),(0,_jquery2["default"])("#header-container").toggle(),(0,_jquery2["default"])(".header-bar").toggle()}},{key:"present",value:function(){this.presenter.presenting.set(!0)}},{key:"unpresent",value:function(){this.presenter.presenting.set(!1)}},{key:"initToolbar",value:function(){var e=this;(0,_jquery2["default"])("#view_menu").append((0,_jquery2["default"])("<li/>").append((0,_jquery2["default"])("<a/>").text("Toggle Present").on("click",function(){e.show()}))),_baseJsNamespace2["default"].toolbar.add_buttons_group([{label:"Slide Sorter",icon:"fa-th-large",callback:function(){return e.show()},id:"nbpresent_sorter_btn"},{label:"Present",icon:"fa-youtube-play",callback:function(){return e.present()},id:"nbpresent_present_btn"}]);var t=this,r=[],s=function(e,r){var s=_d32["default"].select(e[0]);s.append("i").attr("class","fa fa-link"),s.append("span").text(" Region ");s.selectAll(".btn").data([_parts.PART.source,_parts.PART.outputs,_parts.PART.widgets]).enter().append("button").classed({btn:1,"btn-default":1,"btn-xs":1}).text(function(e){return e}).on("click",function(e){return t.sorter.linkContent(e)})};_notebookJsCelltoolbar.CellToolbar.register_callback("nbpresent.add_to_region",s),r.push("nbpresent.add_to_region"),_notebookJsCelltoolbar.CellToolbar.register_preset("nbpresent",r,_baseJsNamespace2["default"].notebook)}}]),e}();exports.NBPresent=NBPresent;

},{"./parts":48,"./presenter":49,"./sorter":51,"./tour":53,"baobab":1,"base/js/namespace":"base/js/namespace","d3":11,"jquery":"jquery","notebook/js/celltoolbar":"notebook/js/celltoolbar"}],48:[function(require,module,exports){
...
},{"d3":11}],53:[function(require,module,exports){
...
},{"./parts":48,"bootstraptour":"bootstraptour"}]},{},[44])(44)
});