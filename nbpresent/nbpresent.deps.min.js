...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}function err(e,r,t){return(0,_helpers.makeError)('Baobab.update: cannot apply the "'+e+'" on '+("a non "+r+" (path: /"+t.join("/")+")."),{path:t})}function update(e,r,t){var a=arguments.length<=3||void 0===arguments[3]?{}:arguments[3],l=t.type,p=t.value,o={root:e},s=["root"].concat(_toConsumableArray(r)),n=[],u=o,i=void 0,f=void 0,y=void 0;for(i=0,f=s.length;f>i;i++){if(y=s[i],i>0&&n.push(y),i===f-1){if("set"===l){if(a.pure&&u[y]===p)return{node:u[y]};_type2["default"].lazyGetter(u,y)?Object.defineProperty(u,y,{value:p,enumerable:!0,configurable:!0}):a.persistent?u[y]=(0,_helpers.shallowClone)(p):u[y]=p}else if("monkey"===l)Object.defineProperty(u,y,{get:p,enumerable:!0,configurable:!0});else if("apply"===l){var d=p(u[y]);if(a.pure&&u[y]===d)return{node:u[y]};_type2["default"].lazyGetter(u,y)?Object.defineProperty(u,y,{value:d,enumerable:!0,configurable:!0}):a.persistent?u[y]=(0,_helpers.shallowClone)(d):u[y]=d}else if("push"===l){if(!_type2["default"].array(u[y]))throw err("push","array",n);a.persistent?u[y]=u[y].concat([p]):u[y].push(p)}else if("unshift"===l){if(!_type2["default"].array(u[y]))throw err("unshift","array",n);a.persistent?u[y]=[p].concat(u[y]):u[y].unshift(p)}else if("concat"===l){if(!_type2["default"].array(u[y]))throw err("concat","array",n);a.persistent?u[y]=u[y].concat(p):u[y].push.apply(u[y],p)}else if("splice"===l){if(!_type2["default"].array(u[y]))throw err("splice","array",n);a.persistent?u[y]=_helpers.splice.apply(null,[u[y]].concat(p)):u[y].splice.apply(u[y],p)}else if("unset"===l)_type2["default"].object(u)?delete u[y]:_type2["default"].array(u)&&u.splice(y,1);else if("merge"===l){if(!_type2["default"].object(u[y]))throw err("merge","object",n);a.persistent?u[y]=(0,_helpers.shallowMerge)({},u[y],p):u[y]=(0,_helpers.shallowMerge)(u[y],p)}else if("deepMerge"===l){if(!_type2["default"].object(u[y]))throw err("deepMerge","object",n);a.persistent?u[y]=(0,_helpers.deepMerge)({},u[y],p):u[y]=(0,_helpers.deepMerge)(u[y],p)}a.immutable&&(0,_helpers.deepFreeze)(u);break}_type2["default"].primitive(u[y])?u[y]={}:a.persistent&&(u[y]=(0,_helpers.shallowClone)(u[y])),a.immutable&&f>0&&(0,_helpers.freeze)(u),u=u[y]}return _type2["default"].lazyGetter(u,y)?{data:o.root}:{data:o.root,node:u[y]}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=update;var _type=require("./type"),_type2=_interopRequireDefault(_type),_helpers=require("./helpers");module.exports=exports["default"];

},{"./helpers":3,"./type":5}],7:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,r,a){return r&&e(t.prototype,r),a&&e(t,a),t}}(),_get=function(e,t,r){for(var a=!0;a;){var n=e,i=t,o=r;a=!1,null===n&&(n=Function.prototype);var u=Object.getOwnPropertyDescriptor(n,i);if(void 0!==u){if("value"in u)return u.value;var s=u.get;if(void 0===s)return;return s.call(o)}var l=Object.getPrototypeOf(n);if(null===l)return;e=l,t=i,r=o,a=!0,u=l=void 0}},_emmett=require("emmett"),_emmett2=_interopRequireDefault(_emmett),_cursor=require("./cursor"),_cursor2=_interopRequireDefault(_cursor),_type=require("./type"),_type2=_interopRequireDefault(_type),_helpers=require("./helpers"),Watcher=function(e){function t(e,r){var a=this;_classCallCheck(this,t),_get(Object.getPrototypeOf(t.prototype),"constructor",this).call(this),this.tree=e,this.mapping=null,this.state={killed:!1},this.refresh(r),this.handler=function(e){if(!a.state.killed){var t=a.getWatchedPaths();return(0,_helpers.solveUpdate)(e.data.paths,t)?a.emit("update"):void 0}},this.tree.on("update",this.handler)}return _inherits(t,e),_createClass(t,[{key:"getWatchedPaths",value:function(){var e=this,t=Object.keys(this.mapping).map(function(t){var r=e.mapping[t];return r instanceof _cursor2["default"]?r.solvedPath:e.mapping[t]});return t.reduce(function(t,r){if(_type2["default"].dynamicPath(r)&&(r=(0,_helpers.getIn)(e.tree._data,r).solvedPath),!r)return t;var a=_type2["default"].monkeyPath(e.tree._monkeys,r);return a?t.concat((0,_helpers.getIn)(e.tree._monkeys,a).data.relatedPaths()):t.concat([r])},[])}},{key:"getCursors",value:function(){var e=this,t={};return Object.keys(this.mapping).forEach(function(r){var a=e.mapping[r];a instanceof _cursor2["default"]?t[r]=a:t[r]=e.tree.select(a)}),t}},{key:"refresh",value:function(e){if(!_type2["default"].watcherMapping(e))throw(0,_helpers.makeError)("Baobab.watch: invalid mapping.",{mapping:e});this.mapping=e;var t={};for(var r in e)t[r]=e[r]instanceof _cursor2["default"]?e[r].path:e[r];this.get=this.tree.project.bind(this.tree,t)}},{key:"release",value:function(){this.tree.off("update",this.handler),this.state.killed=!0,this.kill()}}]),t}(_emmett2["default"]);exports["default"]=Watcher,module.exports=exports["default"];
...
},{"./get-item-width":44,"./init":46,"./slabify":48,"./verify-string":49}],46:[function(require,module,exports){
...
},{"../utils/debounce":50}],47:[function(require,module,exports){
...
},{"./set-font":47}],49:[function(require,module,exports){
