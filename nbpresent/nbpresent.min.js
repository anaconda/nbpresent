...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _slicedToArray=function(){function e(e,t){var i=[],n=!0,s=!1,l=void 0;try{for(var r,o=e[Symbol.iterator]();!(n=(r=o.next()).done)&&(i.push(r.value),!t||i.length!==t);n=!0);}catch(a){s=!0,l=a}finally{try{!n&&o["return"]&&o["return"]()}finally{if(s)throw l}}return i}return function(t,i){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,i);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),_d3=require("d3"),_d32=_interopRequireDefault(_d3),_nodeUuid=require("node-uuid"),_nodeUuid2=_interopRequireDefault(_nodeUuid),_baseJsNamespace=require("base/js/namespace"),_baseJsNamespace2=_interopRequireDefault(_baseJsNamespace),_editor=require("./editor"),_toolbar=require("./toolbar"),_parts=require("./parts"),_cells=require("./cells"),REMOVED="<removed>",Sorter=function(){function e(t){var i=this;_classCallCheck(this,e),this.tree=t,this.cellManager=new _cells.CellManager,this.visible=this.tree.select(["sorter","visible"]),this.visible.set(!1),this.$view=_d32["default"].select("#header").append("div").classed({nbpresent_sorter:1,offscreen:1}).style({display:"none"}),this.$slides=this.$view.append("div").classed({slides_wrap:1}),this.$empty=this.$slides.append("h3").classed({empty:1}).text("No slides yet."),this.initToolbar(),this.initDrag(),this.slides=this.tree.select(["slides"]),this.selectedSlide=this.tree.select(["sorter","selectedSlide"]),this.selectedRegion=this.tree.select(["sorter","selectedRegion"]),this.selectedSlide.on("update",function(){return i.updateSelectedSlide()}),this.selectedRegion.on("update",function(){return i.updateSelectedRegion()}),this.slides.on("update",function(){return i.draw()}),this.draw()}return _createClass(e,[{key:"show",value:function(){this.visible.set(!this.visible.get());this.update()}},{key:"update",value:function(){var e=this.visible.get();this.$view.classed({offscreen:!e}).style({display:e?"block":"none"})}},{key:"initDrag",value:function(){var e=this,t=void 0;this.drag=_d32["default"].behavior.drag().on("dragstart",function(e){var i=_d32["default"].select(this).classed({dragging:1});t=parseFloat(i.style("left"))}).on("drag",function(e){_d32["default"].select(this).style({left:(t+=_d32["default"].event.dx)+"px"})}).on("dragend",function(t,i){var n=_d32["default"].select(this).classed({dragging:0}),s=parseFloat(n.style("left")),l=e.tree.get("sortedSlides"),r=Math.floor(s/e.slideWidth()),o=void 0;o=s<e.slideWidth()||0>r?null:r>l.length||!l[r]?l.slice(-1)[0].key:l[r].key,t.key!==o?(e.unlinkSlide(t.key),e.selectedSlide.set(e.appendSlide(o,t.key))):e.draw()})}},{key:"slideHeight",value:function(){return 100}},{key:"slideWidth",value:function(){return 200}},{key:"draw",value:function(){var e=this,t=this,i=this.tree.get("sortedSlides"),n=this.$slides.selectAll(".slide").data(i,function(e){return e.key});n.enter().append("div").classed({slide:1}).call(this.drag).on("mousedown",function(e){t.selectedSlide.set(t.selectedSlide.get()===e.key?null:e.key)}),n.exit().transition().style({top:"200px"}).remove();var s=this.selectedSlide.get(),l=void 0;n.style({"z-index":function(e,t){return t}}).classed({active:function(e){return e.key===s}}).transition().delay(function(e,t){return 10*t}).style({left:function a(t,i){var a=i*e.slideWidth();return t.key===s&&(l=a,e.$slideToolbar.transition().style({left:l+"px",opacity:1,display:"block"})),a+"px"}});var r=n.selectAll(".region").data(function(e){return _d32["default"].entries(e.value.regions).map(function(t){return{slide:e,region:t}})});r.enter().append("div").classed({region:1}).on("click",function(t){e.selectedRegion.set([t.slide.key,t.region.key])}).on("mousemove",function(e){var t=_d32["default"].mouse(this),i=_slicedToArray(t,2),n=i[0],s=i[1];_d32["default"].select(this).style({"background-position":100*(n/(160*e.region.value.width))+"% "+100*(s/(90*e.region.value.height))+"%"})}).on("mouseout",function(e){_d32["default"].select(this).transition().style({"background-position":"0% 0%"})}),r.exit().remove();var o=this.selectedRegion.get();r.classed({active:function d(t){var d=o&&t.slide.key==o[0]&&t.region.key===o[1];return d&&e.$regionToolbar.transition().style({opacity:1,display:"block",left:l+"px"}),d},content_source:function(e){return e.region.value.content&&e.region.value.content.part===_parts.PART.source},content_outputs:function(e){return e.region.value.content&&e.region.value.content.part===_parts.PART.outputs},content_widgets:function(e){return e.region.value.content&&e.region.value.content.part===_parts.PART.widgets}}).style({width:function(e){return 160*e.region.value.width+"px"},height:function(e){return 90*e.region.value.height+"px"},left:function(e){return 160*e.region.value.x+"px"},top:function(e){return 90*e.region.value.y+"px"}}),r.filter(function(e){return e.region.value.content}).filter(function(e){var t=_d32["default"].select(this);return t.classed("active")||"none"===t.style("background-image")}).each(function(e){var i=_d32["default"].select(this);t.cellManager.thumbnail(e.region.value.content).then(function(e){var t=e.uri;e.width,e.height;i.style({"background-image":'url("'+t+'")'})})}),this.$empty.transition().style({opacity:1*!n[0].length}).transition().style({display:n[0].length?"none":"block"})}},{key:"updateSelectedRegion",value:function(){var e=this.selectedRegion.get();if(e){this.selectedSlide.set(e[0]);var t=this.slides.get([e[0],"regions",e[1],"content"]);t&&this.selectCell(t.cell)}else this.$regionToolbar.transition().style({opacity:0}).transition().style({display:"none"});this.draw()}},{key:"selectCell",value:function(e){_baseJsNamespace2["default"].notebook.get_cells().filter(function(t,i){t.metadata.nbpresent&&t.metadata.nbpresent.id==e&&_baseJsNamespace2["default"].notebook.select(i)})}},{key:"updateSelectedSlide",value:function(){var e=this.selectedSlide.get(),t=this.selectedRegion.get();e||this.$slideToolbar.transition().style({opacity:0}).transition().style({display:"none"}),t&&t[0]==e||this.selectedRegion.set(null),this.draw(),this.editor&&this.editSlide(e)}},{key:"initToolbar",value:function(){var e=this;this.deckToolbar=(new _toolbar.Toolbar).btnGroupClass("btn-group-vertical"),this.$deckToolbar=this.$view.append("div").classed({deck_toolbar:1}).datum([[{icon:"plus-square-o",click:function(){return e.addSlide()},tip:"Add Slide"}]]).call(this.deckToolbar.update),this.slideToolbar=new _toolbar.Toolbar,this.$slideToolbar=this.$slides.append("div").classed({slide_toolbar:1}).datum([[{icon:"edit",click:function(){return e.editSlide(e.selectedSlide.get())},tip:"Edit Slide"},{icon:"trash",click:function(){e.removeSlide(e.selectedSlide.get()),e.selectedSlide.set(null)},tip:"Delete Slide"}]]).call(this.slideToolbar.update),this.regionToolbar=new _toolbar.Toolbar,this.$regionToolbar=this.$slides.append("div").classed({region_toolbar:1}).datum([[{icon:"external-link-square",click:function(){return e.linkContent(_parts.PART.source)},tip:"Link Region to Cell Input"},{icon:"external-link",click:function(){return e.linkContent(_parts.PART.outputs)},tip:"Link Region to Cell Output"},{icon:"sliders",click:function(){return e.linkContent(_parts.PART.widgets)},tip:"Link Region to Cell Widgets"},{icon:"unlink",click:function(){return e.linkContent(null)},tip:"Unlink Region"}]]).call(this.regionToolbar.update)}},{key:"linkContent",value:function(e){var t=this.selectedRegion.get(),i=_baseJsNamespace2["default"].notebook.get_selected_cell(),n=void 0;t&&i&&(e?(i.metadata.nbpresent||(i.metadata.nbpresent={id:this.nextId()}),n=i.metadata.nbpresent.id,this.slides.set([t[0],"regions",t[1],"content"],{cell:n,part:e})):this.slides.unset([t[0],"regions",t[1],"content"]))}},{key:"addSlide",value:function(){var e=this.tree.get("sortedSlides").slice(-1),t=this.selectedSlide.get(),i=this.appendSlide(t?t:e.length?e[0].key:null);this.selectedSlide.set(i)}},{key:"editSlide",value:function(e){this.editor&&(this.editor.slide.get("id")===e&&(e=null),this.editor.destroy(),this.editor=null),e&&(this.editor=new _editor.Editor(this.slides.select(e)))}},{key:"nextId",value:function(){return _nodeUuid2["default"].v4()}},{key:"unlinkSlide",value:function(e){var t=this.slides.get(e),i=t.prev,n=this.nextSlide(e);n&&this.slides.set([n,"prev"],i),this.slides.set([e,"prev"],REMOVED)}},{key:"removeSlide",value:function(e){e&&(this.unlinkSlide(e),this.slides.unset(e))}},{key:"nextSlide",value:function(e){var t=this.tree.get("sortedSlides"),i=t.filter(function(t){return t.value.prev===e});return i.length?i[0].key:null}},{key:"newSlide",value:function(e,t){return{id:e,prev:t,regions:{}}}},{key:"appendSlide",value:function(e){var t=arguments.length<=1||void 0===arguments[1]?null:arguments[1],i=this.nextSlide(e);return t?this.slides.set([t,"prev"],e):(t=this.nextId(),this.slides.set(t,this.newSlide(t,e))),i&&this.slides.set([i,"prev"],t),t}}]),e}();exports.Sorter=Sorter;
