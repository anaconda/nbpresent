...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();Object.defineProperty(exports,"__esModule",{value:!0}),exports.Mode=void 0;var _nbpresentDeps=require("nbpresent-deps"),Mode=exports.Mode=function(){function e(t){_classCallCheck(this,e),this.root=t,this.initStylesheet(),this.init()}return _createClass(e,[{key:"initStylesheet",value:function(){var e=_nbpresentDeps.d3.select("head").selectAll("link#nbpresent-css").data([1]);return e.node()?void console.warn("nbpresent extension already loaded!"):void e.enter().append("link").attr({id:"nbpresent-css"}).attr({rel:"stylesheet",href:this.root+"/nbpresent.min.css"})}}]),e}();

},{"nbpresent-deps":"nbpresent-deps"}],9:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}();Object.defineProperty(exports,"__esModule",{value:!0}),exports.Mode=void 0;var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_namespace=require("base/js/namespace"),_namespace2=_interopRequireDefault(_namespace),_celltoolbar=require("notebook/js/celltoolbar"),_nbpresentDeps=require("nbpresent-deps"),_notebook=require("../presenter/notebook"),_sorter=require("../sorter"),_parts=require("../parts"),_tour=require("../tour"),_tree=require("../tree"),_base=require("./base"),Mode=exports.Mode=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,Object.getPrototypeOf(t).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"init",value:function(){var e=this,t=new _tree.Tree({slides:this.metadata().slides,root:this.root});this.tree=t.tree,this.slides=this.tree.select(["slides"]),this.slides.on("update",function(){return e.metadata(!0)}),this.tour=new _tour.NbpresentTour(this),this.tour.init(),this.presenter=new _notebook.NotebookPresenter(this.tree,this.tour),this.sorter=new _sorter.Sorter(this.tree,this.tour),this.initToolbar()}},{key:"metadata",value:function(e){var t=_namespace2["default"].notebook.metadata;return e?void(t.nbpresent={slides:this.slides.serialize()}):t.nbpresent||{slides:{}}}},{key:"show",value:function(){this.sorter.show(),this.tour.start(),(0,_jquery2["default"])("#header-container").toggle(),(0,_jquery2["default"])(".header-bar").toggle()}},{key:"present",value:function(){this.presenter.presenting.set(!0)}},{key:"unpresent",value:function(){this.presenter.presenting.set(!1)}},{key:"initToolbar",value:function(){var e=this;(0,_jquery2["default"])("#view_menu").append((0,_jquery2["default"])("<li/>").append((0,_jquery2["default"])("<a/>").text("Toggle Present").on("click",function(){e.show()}))),_namespace2["default"].toolbar.add_buttons_group([{label:"Slide Sorter",icon:"fa-th-large",callback:function(){return e.show()},id:"nbpresent_sorter_btn"},{label:"Present",icon:"fa-youtube-play",callback:function(){return e.present()},id:"nbpresent_present_btn"}]);var t=this,r=[],n=function(e,r){var n=_nbpresentDeps.d3.select(e[0]);n.append("i").attr("class","fa fa-link"),n.append("span").text(" Region ");n.selectAll(".btn").data([_parts.PART.source,_parts.PART.outputs,_parts.PART.widgets]).enter().append("button").classed({btn:1,"btn-default":1,"btn-xs":1}).text(function(e){return e}).on("click",function(e){return t.sorter.linkContent(e)})};_celltoolbar.CellToolbar.register_callback("nbpresent.add_to_region",n),r.push("nbpresent.add_to_region"),_celltoolbar.CellToolbar.register_preset("nbpresent",r,_namespace2["default"].notebook);var o=_nbpresentDeps.d3.select(_nbpresentDeps.d3.select("#download_html").node().parentNode);o.insert("li",":nth-child(4)").append("a").text("Presentation (.zip)").on("click",function(){return e.nbconvert("nbpresent")}),o.insert("li",":nth-child(5)").append("a").text("Presentation (.pdf)").on("click",function(){return e.nbconvert("nbpresent_pdf")})}},{key:"nbconvert",value:function(e){_namespace2["default"].menubar._nbconvert(e,!0)}}]),t}(_base.Mode);
