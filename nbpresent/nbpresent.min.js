(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.nbpresent = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,a){if(!(e instanceof a))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,a){for(var t=0;t<a.length;t++){var n=a[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(a,t,n){return t&&e(a.prototype,t),n&&e(a,n),a}}(),_d3=require("d3"),_d32=_interopRequireDefault(_d3),_html2canvas=require("html2canvas"),_html2canvas2=_interopRequireDefault(_html2canvas),_baseJsNamespace=require("base/js/namespace"),_baseJsNamespace2=_interopRequireDefault(_baseJsNamespace),_parts=require("./parts");window.html2canvas=_html2canvas2["default"];var CellManager=function(){function e(){_classCallCheck(this,e)}return _createClass(e,[{key:"getPart",value:function(e){var a=_baseJsNamespace2["default"].notebook.get_cells().reduce(function(e,a){return a.metadata.nbpresent&&(e[a.metadata.nbpresent.id]=a),e},{}),t=a[e.cell],n=_d32["default"].select(t.element[0]),r=n.select(_parts.PART_SELECT[e.part]);return r}},{key:"thumbnail",value:function(e){var a=this.getPart(e).node();return(0,_html2canvas2["default"])(a).then(function(e){return{canvas:e,uri:e.toDataURL("image/png"),width:e.width,height:e.height}},function(e){console.log(e)})}}]),e}();exports.CellManager=CellManager;

},{"./parts":46,"base/js/namespace":"base/js/namespace","d3":11,"html2canvas":15}],43:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),_d3=require("d3"),_d32=_interopRequireDefault(_d3),_nodeUuid=require("node-uuid"),_nodeUuid2=_interopRequireDefault(_nodeUuid),_toolbar=require("./toolbar"),directions=["nw","n","ne","e","se","s","sw","w"],Editor=function(){function e(t){var i=this;_classCallCheck(this,e),this.slide=t,this.regions=this.slide.select("regions"),this.x=_d32["default"].scale.linear(),this.y=_d32["default"].scale.linear(),this.initUI(),this.initBehavior(),this.update(),this.slide.on("update",function(){i.killed||i.update()})}return _createClass(e,[{key:"destroy",value:function(){this.$ui.transition().style({opacity:0}).remove(),this.killed=!0}},{key:"initUI",value:function(){this.$ui=_d32["default"].select("body").append("div").classed({nbpresent_editor:1}).style({opacity:0}),this.initToolbar(),this.$bg=this.$ui.append("div").classed({slide_bg:1}),this.$svg=this.$bg.append("svg"),this.$ui.transition().style({opacity:1})}},{key:"initToolbar",value:function(){var e=this,t=new _toolbar.Toolbar;this.$toolbar=this.$ui.append("div").datum([[{icon:"plus-square-o",click:function(){return e.addRegion()},tip:"Add Region"}]]).call(t.update)}},{key:"initBehavior",value:function(){var e=this,t=this.x,i=this.y,n=void 0,r=void 0,a=void 0,d=void 0;this.regionDrag=_d32["default"].behavior.drag().on("dragstart",function(e){_d32["default"].select(this.parentNode).classed({dragging:1});n=e.value.x,r=e.value.y}).on("drag",function(e){n+=t.invert(_d32["default"].event.dx),r+=i.invert(_d32["default"].event.dy);_d32["default"].select(this.parentNode).attr({transform:function(e){return"translate("+[t(n),i(r)]+")"}})}).on("dragend",function(t){_d32["default"].select(this.parentNode).classed({dragging:0});e.regions.merge(t.key,{x:n,y:r})}),this.handleDrag=_d32["default"].behavior.drag().origin(function(e){return{x:0,y:0}}).on("dragstart",function(e){_d32["default"].select(this).classed({dragging:1});n=e.region.value.x,r=e.region.value.y,a=e.region.value.width,d=e.region.value.height}).on("drag",function(e){var s=(_d32["default"].select(this),_d32["default"].select(this.parentNode)),o=t.invert(_d32["default"].event.dx),l=i.invert(_d32["default"].event.dy);/n/.test(e.dir)&&(r+=l,d-=l),/e/.test(e.dir)&&(a+=o),/s/.test(e.dir)&&(d+=l),/w/.test(e.dir)&&(n+=o,a-=o),s.attr({transform:function(e){return"translate("+[t(n),i(r)]+")"}}).select(".region_bg").attr({width:t(a),height:i(d)}),s.selectAll(".handle").attr({cx:function(e){return t(/w/.test(e.dir)?0:/e/.test(e.dir)?a:a/2)},cy:function(e){return i(/n/.test(e.dir)?0:/s/.test(e.dir)?d:d/2)}})}).on("dragend",function(t){_d32["default"].select(this).classed({dragging:0});e.regions.merge(t.region.key,{x:n,y:r,width:a,height:d})})}},{key:"addRegion",value:function(){var e=_nodeUuid2["default"].v4();this.regions.set(e,{id:e,x:.1,y:.1,width:.8,height:.8})}},{key:"padding",value:function(){return 20}},{key:"aspectRatio",value:function(){return 16/9}},{key:"update",value:function(){var e=this,t=this.$ui.node().getBoundingClientRect(),i=t.width-2*this.padding(),n=i/this.aspectRatio();n>t.height+2*this.padding()&&(n=t.height-2*this.padding(),i=n*this.aspectRatio()),this.x.range([0,i]),this.y.range([0,n]);var r=this.x,a=this.y;this.$bg.style({left:(t.width-i)/2+"px",top:(t.height-n)/2+"px",width:i+"px",height:n+"px"}),this.$svg.attr({width:i,height:n});var d=_d32["default"].entries(this.regions.get()),s=this.$svg.selectAll(".region").data(d,function(e){return e.key});s.exit().remove();var o=function(e){return directions.map(function(t){return{region:e,dir:t}})};s.enter().append("g").classed({region:1}).call(function(t){t.append("rect").classed({region_bg:1}).call(e.regionDrag);var i=t.selectAll(".handle").data(o);i.enter().append("circle").classed({handle:1}).attr({r:5}).call(e.handleDrag)}),s.attr({transform:function(e){return"translate("+[r(e.value.x),a(e.value.y)]+")"}}).select(".region_bg").attr({width:function(e){return r(e.value.width)},height:function(e){return a(e.value.height)}}),s.selectAll(".handle").data(o).attr({cx:function(e){return r(/w/.test(e.dir)?0:/e/.test(e.dir)?e.region.value.width:e.region.value.width/2)},cy:function(e){return a(/n/.test(e.dir)?0:/s/.test(e.dir)?e.region.value.height:e.region.value.height/2)}})}}]),e}();exports.Editor=Editor;

},{"./toolbar":49,"d3":11,"node-uuid":41}],44:[function(require,module,exports){
"use strict";function load_ipython_extension(){detectRoot(function(){return new _nbpresent.NBPresent})}function detectRoot(e){var n="nbextensions/nbpresent",t="https://continuumio.github.io/nbpresent/nbpresent";requirejs([n+"/nbpresent.min"],function(){return initStylesheet("/"+n,e)},function(){return initStylesheet(t,e)})}function initStylesheet(e,n){var t=d3.select("head").selectAll("link#nbpresent-css").data([1]);return t.node()?void console.warn("nbpresent extension already loaded!"):(t.enter().append("link").attr({id:"nbpresent-css"}).attr({rel:"stylesheet",href:e+"/nbpresent.min.css"}),void n())}Object.defineProperty(exports,"__esModule",{value:!0}),exports.load_ipython_extension=load_ipython_extension;var _nbpresent=require("./nbpresent");

},{"./nbpresent":45}],45:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}(),_d3=require("d3"),_d32=_interopRequireDefault(_d3),_baobab=require("baobab"),_baobab2=_interopRequireDefault(_baobab),_baseJsNamespace=require("base/js/namespace"),_baseJsNamespace2=_interopRequireDefault(_baseJsNamespace),_presenter=require("./presenter"),_sorter=require("./sorter"),NBPresent=function(){function e(){var t=this;_classCallCheck(this,e),this.tree=new _baobab2["default"]({slides:this.metadata().slides,presenter:{},sorter:{},editor:{},sortedSlides:_baobab2["default"].monkey(["slides"],this.sortedSlides)}),this.slides=this.tree.select(["slides"]),this.slides.on("update",function(){return t.metadata(!0)}),this.presenter=new _presenter.Presenter(this.tree),this.sorter=new _sorter.Sorter(this.tree),this.initToolbar()}return _createClass(e,[{key:"metadata",value:function(e){var t=_baseJsNamespace2["default"].notebook.metadata;return e?void(t.nbpresent={slides:this.slides.serialize()}):t.nbpresent||{slides:{}}}},{key:"sortedSlides",value:function(e){var t=_d32["default"].entries(e);return t.sort(function(e,t){return null===e.value.prev||e.key===t.value.prev?-1:1}),t}},{key:"initToolbar",value:function(){var e=this;_baseJsNamespace2["default"].toolbar.add_buttons_group([{label:"Slide Sorter",icon:"fa-th-large",callback:function(){return e.sorter.show()},id:"nbpresent_sorter_btn"},{label:"Present",icon:"fa-youtube-play",callback:function(){return e.tree.set(["presenter","presenting"],!e.tree.get(["presenter","presenting"]))},id:"nbpresent_present_btn"}])}}]),e}();exports.NBPresent=NBPresent;

},{"./presenter":47,"./sorter":48,"baobab":1,"base/js/namespace":"base/js/namespace","d3":11}],46:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),_d3=require("d3"),_d32=_interopRequireDefault(_d3),_baseJsNamespace=require("base/js/namespace"),_baseJsNamespace2=_interopRequireDefault(_baseJsNamespace),_toolbar=require("./toolbar"),_parts=require("./parts"),Presenter=function(){function e(t){var n=this;_classCallCheck(this,e),this.tree=t,this.initUI(),this.x=_d32["default"].scale.linear(),this.y=_d32["default"].scale.linear(),this.presenting=this.tree.select(["presenter","presenting"]),this.current=this.tree.select(["presenter","current"]),this.presenting.on("update",function(){return n.present()}),this.current.on("update",function(){return n.update()})}return _createClass(e,[{key:"initUI",value:function(){this.$ui=_d32["default"].select("body").append("div").classed({nbpresent_presenter:1}).style({display:"none"}),this.initToolbar()}},{key:"initToolbar",value:function(){var e=this,t=new _toolbar.Toolbar;t.btnClass("btn-invert"),this.$toolbar=this.$ui.append("div").datum([[{icon:"dedent",click:function(){return e.presenting.set(!1)}},{icon:"fast-backward",click:function(){return e.current.set(0)}},{icon:"step-backward",click:function(){return e.current.set(e.current.get()-1)}},{icon:"step-forward",click:function(){return e.current.set(e.current.get()+1)}}]]).call(t.update)}},{key:"present",value:function(){var e=this.presenting.get();this.$ui.style({display:e?"block":"none"}).transition().style({opacity:+e}),this.current.set(0),e||this.clean(!0)}},{key:"update",value:function(){var e=this;if(!this.presenting.get())return this.clean(!0);var t=document.documentElement,n=t.clientWidth,r=t.clientHeight;this.x.range([0,n]),this.y.range([0,r]);var s=this.tree.get("sortedSlides")[this.current.get()];if(!s)return this.current.set(0);var a=_baseJsNamespace2["default"].notebook.get_cells().reduce(function(e,t){return t.metadata.nbpresent&&(e[t.metadata.nbpresent.id]=t),e},{});_d32["default"].selectAll(this.allPartSelect()).classed({nbpresent_unpresent:1,nbpresent_present:0}),_d32["default"].entries(s.value.regions).filter(function(e){return e.value.content}).map(function(t){var n=t.value,r=n.content,s=n.x,i=n.y,l=n.width,u=n.height,c=a[r.cell],o=_d32["default"].select(c.element[0]),p=o.select(_parts.PART_SELECT[r.part]);p.classed({nbpresent_unpresent:0,nbpresent_present:1}).transition().style({left:e.x(s)+"px",top:e.y(i)+"px",width:e.x(l)+"px",height:e.y(u)+"px"})}),this.clean()}},{key:"allPartSelect",value:function(){return _d32["default"].entries(_parts.PART_SELECT).map(function(e){var t=e.value;return".cell "+t}).join(", ")}},{key:"clean",value:function(e){e&&_d32["default"].selectAll(this.allPartSelect()).classed({nbpresent_unpresent:1,nbpresent_present:0}),_d32["default"].selectAll(".nbpresent_unpresent").style({left:null,top:null,width:null,height:null}).classed({nbpresent_unpresent:0,nbpresent_present:0})}}]),e}();exports.Presenter=Presenter;

},{"./parts":46,"./toolbar":49,"base/js/namespace":"base/js/namespace","d3":11}],48:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _slicedToArray=function(){function e(e,t){var i=[],n=!0,l=!1,s=void 0;try{for(var r,o=e[Symbol.iterator]();!(n=(r=o.next()).done)&&(i.push(r.value),!t||i.length!==t);n=!0);}catch(a){l=!0,s=a}finally{try{!n&&o["return"]&&o["return"]()}finally{if(l)throw s}}return i}return function(t,i){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,i);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),_d3=require("d3"),_d32=_interopRequireDefault(_d3),_nodeUuid=require("node-uuid"),_nodeUuid2=_interopRequireDefault(_nodeUuid),_baseJsNamespace=require("base/js/namespace"),_baseJsNamespace2=_interopRequireDefault(_baseJsNamespace),_editor=require("./editor"),_toolbar=require("./toolbar"),_parts=require("./parts"),_cells=require("./cells"),REMOVED="<removed>",Sorter=function(){function e(t){var i=this;_classCallCheck(this,e),this.tree=t,this.cellManager=new _cells.CellManager,this.visible=this.tree.select(["sorter","visible"]),this.visible.set(!1),this.$view=_d32["default"].select("#header").append("div").classed({nbpresent_sorter:1,offscreen:1}).style({display:"none"}),this.initToolbar(),this.initDrag(),this.$slides=this.$view.append("div").classed({slides_wrap:1}),this.$empty=this.$slides.append("h3").classed({empty:1}).text("No slides yet."),this.slides=this.tree.select(["slides"]),this.selectedSlide=this.tree.select(["sorter","selectedSlide"]),this.selectedRegion=this.tree.select(["sorter","selectedRegion"]),this.selectedSlide.on("update",function(){return i.updateSelectedSlide()}),this.selectedRegion.on("update",function(){return i.updateSelectedRegion()}),this.slides.on("update",function(){return i.draw()}),this.draw()}return _createClass(e,[{key:"show",value:function(){this.visible.set(!this.visible.get()),this.update()}},{key:"update",value:function(){var e=this.visible.get();this.$view.classed({offscreen:!e}).style({display:e?"block":"none"}),_d32["default"].select("#notebook-container").style({width:e?"auto":null,"margin-right":e?"240px":null,"margin-left":e?"20px":null})}},{key:"initDrag",value:function(){var e=this,t=void 0;this.drag=_d32["default"].behavior.drag().on("dragstart",function(e){var i=_d32["default"].select(this).classed({dragging:1});t=parseFloat(i.style("top"))}).on("drag",function(e){_d32["default"].select(this).style({top:(t+=_d32["default"].event.dy)+"px"})}).on("dragend",function(t,i){var n=_d32["default"].select(this).classed({dragging:0}),l=parseFloat(n.style("top")),s=e.tree.get("sortedSlides"),r=Math.floor(l/e.slideHeight()),o=void 0;o=l<e.slideHeight()||0>r?null:r>s.length||!s[r]?s.slice(-1)[0].key:s[r].key,t.key!==o?(e.unlinkSlide(t.key),e.selectedSlide.set(e.appendSlide(o,t.key))):e.draw()})}},{key:"slideHeight",value:function(){return 100}},{key:"draw",value:function(){var e=this,t=this,i=this.tree.get("sortedSlides"),n=this.$slides.selectAll(".slide").data(i,function(e){return e.key});n.enter().append("div").classed({slide:1}).call(this.drag).on("mousedown",function(e){t.selectedSlide.set(t.selectedSlide.get()===e.key?null:e.key)}).style({left:"200px"}),n.exit().transition().style({left:"200px"}).remove();var l=this.selectedSlide.get(),s=void 0;n.style({"z-index":function(e,t){return t}}).classed({active:function(e){return e.key===l}}).transition().delay(function(e,t){return 10*t}).style({left:"0px",top:function a(t,i){var a=i*e.slideHeight();return t.key===l&&(s=a+32,e.$slideToolbar.transition().style({top:s+"px",opacity:1,display:"block"})),a+"px"}});var r=n.selectAll(".region").data(function(e){return _d32["default"].entries(e.value.regions).map(function(t){return{slide:e,region:t}})});r.enter().append("div").classed({region:1}).on("click",function(t){e.selectedRegion.set([t.slide.key,t.region.key])}).on("mousemove",function(e){var t=_d32["default"].mouse(this),i=_slicedToArray(t,2),n=i[0],l=i[1];_d32["default"].select(this).style({"background-position":100*(n/(160*e.region.value.width))+"% "+100*(l/(90*e.region.value.height))+"%"})}).on("mouseout",function(e){_d32["default"].select(this).transition().style({"background-position":"0% 0%"})}),r.exit().remove();var o=this.selectedRegion.get();r.classed({active:function d(t){var d=o&&t.slide.key==o[0]&&t.region.key===o[1];return d&&e.$regionToolbar.transition().style({opacity:1,display:"block",top:s+"px"}),d},content_source:function(e){return e.region.value.content&&e.region.value.content.part===_parts.PART.source},content_outputs:function(e){return e.region.value.content&&e.region.value.content.part===_parts.PART.outputs},content_widgets:function(e){return e.region.value.content&&e.region.value.content.part===_parts.PART.widgets}}).style({width:function(e){return 160*e.region.value.width+"px"},height:function(e){return 90*e.region.value.height+"px"},left:function(e){return 160*e.region.value.x+"px"},top:function(e){return 90*e.region.value.y+"px"}}),r.filter(function(e){return e.region.value.content}).filter(function(e){var t=_d32["default"].select(this);return t.classed("active")||"none"===t.style("background-image")}).each(function(e){var i=_d32["default"].select(this);t.cellManager.thumbnail(e.region.value.content).then(function(e){var t=e.uri;e.width,e.height;i.style({"background-image":'url("'+t+'")'})})}),this.$empty.style({opacity:1*!n[0].length})}},{key:"updateSelectedRegion",value:function(){var e=this.selectedRegion.get();if(e){this.selectedSlide.set(e[0]);var t=this.slides.get([e[0],"regions",e[1],"content"]);t&&this.selectCell(t.cell)}else this.$regionToolbar.transition().style({opacity:0}).transition().style({display:"none"});this.draw()}},{key:"selectCell",value:function(e){_baseJsNamespace2["default"].notebook.get_cells().filter(function(t,i){t.metadata.nbpresent&&t.metadata.nbpresent.id==e&&_baseJsNamespace2["default"].notebook.select(i)})}},{key:"updateSelectedSlide",value:function(){var e=this.selectedSlide.get(),t=this.selectedRegion.get();e||this.$slideToolbar.transition().style({opacity:0}).transition().style({display:"none"}),t&&t[0]==e||this.selectedRegion.set(null),this.draw(),this.editor&&this.editSlide(e)}},{key:"initToolbar",value:function(){var e=this;this.deckToolbar=new _toolbar.Toolbar,this.$deckToolbar=this.$view.append("div").datum([[{icon:"plus-square-o",click:function(){return e.addSlide()},tip:"Add Slide"}]]).call(this.deckToolbar.update),this.slideToolbar=new _toolbar.Toolbar,this.slideToolbar.btnGroupClass("btn-group-vertical"),this.$slideToolbar=this.$view.append("div").classed({slide_toolbar:1}).datum([[{icon:"edit",click:function(){return e.editSlide(e.selectedSlide.get())},tip:"Edit Slide"},{icon:"trash",click:function(){e.removeSlide(e.selectedSlide.get()),e.selectedSlide.set(null)},tip:"Delete Slide"}]]).call(this.slideToolbar.update),this.regionToolbar=new _toolbar.Toolbar,this.regionToolbar.btnGroupClass("btn-group-vertical"),this.$regionToolbar=this.$view.append("div").classed({region_toolbar:1}).datum([[{icon:"external-link-square",click:function(){return e.linkContent(_parts.PART.source)},tip:"Link Region to Cell Input"},{icon:"external-link",click:function(){return e.linkContent(_parts.PART.outputs)},tip:"Link Region to Cell Output"},{icon:"sliders",click:function(){return e.linkContent(_parts.PART.widgets)},tip:"Link Region to Cell Widgets"},{icon:"unlink",click:function(){return e.linkContent(null)},tip:"Unlink Region"}]]).call(this.regionToolbar.update)}},{key:"linkContent",value:function(e){var t=this.selectedRegion.get(),i=_baseJsNamespace2["default"].notebook.get_selected_cell(),n=void 0;t&&i&&(e?(i.metadata.nbpresent||(i.metadata.nbpresent={id:this.nextId()}),n=i.metadata.nbpresent.id,this.slides.set([t[0],"regions",t[1],"content"],{cell:n,part:e})):this.slides.unset([t[0],"regions",t[1],"content"]))}},{key:"addSlide",value:function(){var e=this.tree.get("sortedSlides").slice(-1),t=this.selectedSlide.get(),i=this.appendSlide(t?t:e.length?e[0].key:null);this.selectedSlide.set(i)}},{key:"editSlide",value:function(e){this.editor&&(this.editor.slide.get("id")===e&&(e=null),this.editor.destroy(),this.editor=null),e&&(this.editor=new _editor.Editor(this.slides.select(e)))}},{key:"nextId",value:function(){return _nodeUuid2["default"].v4()}},{key:"unlinkSlide",value:function(e){var t=this.slides.get(e),i=t.prev,n=this.nextSlide(e);n&&this.slides.set([n,"prev"],i),this.slides.set([e,"prev"],REMOVED)}},{key:"removeSlide",value:function(e){e&&(this.unlinkSlide(e),this.slides.unset(e))}},{key:"nextSlide",value:function(e){var t=this.tree.get("sortedSlides"),i=t.filter(function(t){return t.value.prev===e});return i.length?i[0].key:null}},{key:"newSlide",value:function(e,t){return{id:e,prev:t,regions:{}}}},{key:"appendSlide",value:function(e){var t=arguments.length<=1||void 0===arguments[1]?null:arguments[1],i=this.nextSlide(e);return t?this.slides.set([t,"prev"],e):(t=this.nextId(),this.slides.set(t,this.newSlide(t,e))),i&&this.slides.set([i,"prev"],t),t}}]),e}();exports.Sorter=Sorter;

},{"./cells":42,"./editor":43,"./parts":46,"./toolbar":49,"base/js/namespace":"base/js/namespace","d3":11,"node-uuid":41}],49:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{"default":t}}function _classCallCheck(t,n){if(!(t instanceof n))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,n){for(var e=0;e<n.length;e++){var r=n[e];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(n,e,r){return e&&t(n.prototype,e),r&&t(n,r),n}}(),_d3=require("d3"),_d32=_interopRequireDefault(_d3),fn=_d32["default"].functor,Toolbar=function(){function t(){_classCallCheck(this,t),this._btnClass=fn("btn-default btn-xs"),this._btnGroupClass=fn("btn-group"),this.update=this.update.bind(this)}return _createClass(t,[{key:"btnClass",value:function(t){return arguments.length?[this._btnClass=fn(t),this][1]:this._btnClass}},{key:"btnGroupClass",value:function(t){return arguments.length?[this._btnGroupClass=fn(t),this][1]:this._btnGroupClass}},{key:"update",value:function(t){var n=this;t.classed({"btn-toolbar":1});var e=t.selectAll(".btn-toolbar-group").data(function(t){return t});e.enter().append("div").classed({"btn-toolbar-group":1}).classed(this._btnGroupClass(),1);var r=e.selectAll(".btn").data(function(t){return t});r.enter().append("a").attr("class",function(t){return"btn "+n._btnClass(t)}).append("i"),r.on("click",function(t){return t.click()}).attr({title:function(t){return t.tip}}).select("i").attr({"class":function(t){return"fa fa-fw fa-"+t.icon}})}}]),t}();exports.Toolbar=Toolbar;
